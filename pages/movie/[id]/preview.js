...
export default function Movie({ user, movie, data}) {
    ...
    const addToWatchList = async (e) => {
        ...
        const addedtowatchlist = await fetch(`${process.env.NEXT_PUBLIC_VERCEL_URL}/api/movie/wannawatch`, {
            method: 'POST',
    ...
    const removeWatchList = async (e) => {
        const removed = await fetch(`${process.env.NEXT_PUBLIC_VERCEL_URL}/api/movie/removewatchlist`, {
        method: 'POST',
        body: JSON.stringify({email: user.email, movie: movie})
        })
        ...
        <main className="main preview-main" style={{width: '100%'}}>
            <div className="relative-wrapper">
                <div className="preview-image-wrapper">
                    ...
                    <div className="preview-image mask"><img src={process.env.NEXT_PUBLIC_VIDEOS_URL + data.thumbnail}/></div>
                </div>
